...
@interface Info {
	int AuthorID() default 1110;

	String Author() default "geetha";

	String Supervisor() default "Mr.nawab";
...
public class problem_2 {
	...
	public static void main(String[] args) {
		...
		PersionalInfo p = new PersionalInfo("satya", 22);
