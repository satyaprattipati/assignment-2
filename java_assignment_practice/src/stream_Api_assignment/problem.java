...
public class problem {
	public static void main(String[] args) {
		...
		// Fruits with calories less than 100
		...
		// Sorting fruits according to their color
		...
		// Unique cities where trader work from
		...
		//  Transaction of a particular year
		...
		//  Transaction from traders living in delhi
